...
import type { IBrand } from "../../redux/api/brandApi";
...
const AllBrands: React.FC = () => {
  ...
  const { data, error, isLoading, refetch, isFetching } = useGetAllBrandsQuery({
  ...
  const handleDeleteBrand = async (brand: IBrand) => {
    try {
      ...
      await Swal.fire({
        icon: "success",
        title: "Deleted!",
        text: `Brand "${brand.name}" has been deleted.`,
        timer: 1500,
      ...
      <div className="overflow-x-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 p-4 border-b border-gray-base">
          <div>
            ...
            <p className="text-sm text-gray-400">Manage all brands</p>
          </div>
              ...
              brands.map((brand, index) => (
                ...
                >
                  ...
                  <td className="py-1 px-4 sm:py-1.5 sm:px-5 border-l border-b border-gray-base">
                    {brand.addedBy ? (
                      <div>
                        <div className="text-sm">{brand.addedBy.name}</div>
                  ...
                  <td className="py-1 px-4 sm:py-1.5 sm:px-5 border-l border-b border-gray-base">
                    <div className="text-xs">
                      ...
                      <div className="text-gray-500">
                        {format(new Date(brand.created_at), "h:mm a")}
                      </div>
                    </div>
                  </td>
